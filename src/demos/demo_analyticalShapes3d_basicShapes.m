...
pose = createPose(center, roll_pitch_yaw);
boxParams.pose = pose;
cylParams.pose = pose;
ellipParams.pose = pose;
ellipCylParams.pose = pose;
sphereParams.pose = pose;
...
function pose = createPose(center, roll_pitch_yaw)
    pose = struct('center', struct('x_mm', center(1), ...
        'y_mm', center(2), ...
        'z_mm', center(3)), ...
        'roll_deg', roll_pitch_yaw(1), ...
        'pitch_deg', roll_pitch_yaw(2), ...
        'yaw_deg', roll_pitch_yaw(3));
end

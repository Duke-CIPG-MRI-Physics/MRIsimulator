...
a_mm = 140;   % semi-axis x [mm]
b_mm = 140;   % semi-axis y [mm]
c_mm = 130;   % semi-axis z [mm]
...
ellipParams = struct('a_mm', a_mm, 'b_mm', b_mm, 'c_mm', c_mm);
ellip = AnalyticalEllipsoid3D(ellipParams, [], center_ellip, [roll_deg, pitch_deg, yaw_deg]);

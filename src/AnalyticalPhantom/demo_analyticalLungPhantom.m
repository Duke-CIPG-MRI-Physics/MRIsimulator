...
fat_outer = AnalyticalBox3D(bodyCenter, fat_roll_deg, fat_pitch_deg, fat_yaw_deg, ...
    patientWidth_outer_mm, patientThickness_outer_mm, 0.2*FOV_mm(3));
% AnalyticalEllipticalCylinder3D(bodyCenter, fat_roll_deg, fat_pitch_deg, fat_yaw_deg, ...
%     patientWidth_outer_mm, patientThickness_outer_mm, 0.2*FOV_mm(3));
...
fat_inner = AnalyticalBox3D(bodyCenter, fat_roll_deg, fat_pitch_deg, fat_yaw_deg, ...

...
vessel_ap_unenhanced = AnalyticalCylinder3D(unenhancedCenter, ...
    ap_vessel_roll_deg, ap_vessel_pitch_deg, ap_vessel_yaw_deg, ...
    vessel_radius_mm, unenhancedLength);

vessel_ap_enhanced = AnalyticalCylinder3D(enhancedCenter, ...
    ap_vessel_roll_deg, ap_vessel_pitch_deg, ap_vessel_yaw_deg, ...
    vessel_radius_mm, enhancedLength);
...
unenhancedVesselIntensity = 0.4;
enhancedVesselIntensity = 2.5;
K = fatIntensity*(fat_outer.kspace(kx, ky, kz) - fat_inner.kspace(kx, ky, kz)) + ...
    ...
    ...
    breast_intensity*(breast_right.kspace(kx, ky, kz)  -  vessel_ap_unenhanced.kspace(kx, ky, kz) - vessel_ap_enhanced.kspace(kx, ky, kz)) + ...
    ...
    unenhancedVesselIntensity*vessel_ap_unenhanced.kspace(kx, ky, kz) + ...
    ...
    enhancedVesselIntensity*vessel_ap_enhanced.kspace(kx, ky, kz);

...
enhancedLength = 10;
unenhancedLenghth = total_vessel_length_mm - enhancedLength;
enhancedCenter = [breast_radius_mm+0.5*breast_gap_mm, ...
    bodyShift + 0.5*(breast_depth_mm) + patientThickness_outer_mm, ...
    0];
unenhancedCenter = [breast_radius_mm+0.5*breast_gap_mm, ...
    bodyShift + 0.5*(breast_depth_mm) + patientThickness_outer_mm, ...
    0];

vessel_ap_unenhanced = AnalyticalCylinder3D(unenhancedCenter, ...
    ap_vessel_roll_deg, ap_vessel_pitch_deg, ap_vessel_yaw_deg, ...
    vessel_radius_mm, unenhancedLenghth);

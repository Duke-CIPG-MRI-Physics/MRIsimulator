classdef EnhancingVessel < MultipleMaterialPhantom
    ...
    properties (Access = private)
        enhancedVessel (1,:) AnalyticalCylinder3D = AnalyticalCylinder3D.empty
        unenhancedVessel (1,:) AnalyticalCylinder3D = AnalyticalCylinder3D.empty
